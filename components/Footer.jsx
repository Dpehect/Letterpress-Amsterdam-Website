        ...
        <div className="footer-inner">
            <div className="footer-top">
                ...
                <div className="footer-column">
                    ...
                    <a href="https://www.google.com/maps/place//data=!4m2!3m1!1s0x47c609c42230a8c7:0x8c6a8737114be883?sa=X&ved=1t:8290&ictx=111" target="_blank" rel="noopener noreferrer" className="footer-map-link">
                ...
                <div className="footer-column">
                    ...
                    <a href="mailto:hello@letterpressamsterdam.co" className="footer-email">hello@letterpressamsterdam.co</a>
            ...
            {/* Big Letterpress Amsterdam wordmark */}
            <div className="footer-bottom">
                <div className="footer-big-text" style={{ textTransform: 'uppercase', fontSize: '9vw', fontWeight: '900', letterSpacing: '-0.3vw', whiteSpace: 'nowrap', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <div className="credits-box">
                            <div className="credits-content">
                                ...
                                <div className="credits-item credit-wiggle">
                                    ...
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">Yunus Emre Gurlek</a></div>
                                </div>
                            </div>
                        </div>
